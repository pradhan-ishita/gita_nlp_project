...
class GitaEmotionRecommender:
    def __init__(self, json_path="gita_vedabase.json"):
            ...
            "fear": [
                {
                    ...
                    "simple_meaning": "Anxiety becomes lighter when you stop carrying the whole future at once."
                },
                {
                    "reference": "Bg. 6.26",
        ...
        # Pre-compute embeddings for all simple meanings
    ...
    def detect_emotion(self, user_text: str) -> str:
        ...
        # Map model labels to our emotion keys
        label_map = {
            "sadness": "sadness",
            "fear": "fear",
            "anger": "anger",
    ...
    def recommend_verses(self, user_text: str, top_k: int = 3):
        ...
        # Step 4: Semantic similarity matching within emotion
